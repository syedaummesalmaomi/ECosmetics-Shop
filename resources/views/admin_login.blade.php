...
<head>
	...
	<!-- end: Favicon -->
			...
			<style type="text/css">
			body {
                background-image: "{{URL::to('frontend/images/logo.png')}}" ;
...
<body>
		<div class="container-fluid-full" style="position: center; left: 300px;">
		<div class="row-fluid">
			...
			<div class="row-fluid">
				...
				<center><h1 style="font-size: 2em; color: rgb(128, 128, 128)"><b>Login to Admin Account</h1></center>
					<form class="form-horizontal" action="{{url('/admin_dashboard')}}" method="post">
                        ...
                        <fieldset>
							...
							<div class="input-prepend" title="Password">
								...
								<center><button type="submit" class="btn btn-primary" style="background-color: rgb(128, 128, 128); border: 0px; font-size: 20px">Login</button></center>
							<div class="clearfix"></div>
					</form>
					<hr>
				</div><!--/span-->
