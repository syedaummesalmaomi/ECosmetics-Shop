...
<body>
		<!-- start: Header -->
	<div class="navbar">
		<div class="navbar-inner" style="background-color: rgb(128, 128, 128)">
			<div class="container-fluid">
				<h1><a class="brand" href={{URL::to('/')}}><img src="{{asset('frontend/images/logo.png')}}" style="width: 100px; height:100px" alt="">
                   ECosmetic</h1>
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						...
						<!-- start: User Dropdown -->
						<li class="dropdown" style="background-color: rgb(128, 128, 128)">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<!-- start: Main Menu -->
			<div id="sidebar-left" class="span2" style="background-color: rgb(128, 128, 128)">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li><a href="{{URL::to('/manage_order')}}"><i class=""></i><span class="hidden-tablet">manage Order</span></a></li>
