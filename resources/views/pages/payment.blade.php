				...
				<div class="row">
					<div class="clearfix col-md-4">
						<div class="logo pull-left">
							<h2><a href={{URL::to('/')}}><img src="{{asset('frontend/images/logo.png')}}" style="width: 50px; height:50px" alt="">
                                ECosmetic</h2>
                        </div>
							...
							<div class="btn-group paymentBtnGroup btn-group-justified" data-toggle="buttons">
					            ...
					            <label class="btn paymentMethod">
					             ...
					             <label class="btn paymentMethod">
					                ...
					                <input type="radio" name="payment_method" value="nogod">
					            </label>
					            <label class="btn paymentMethod">
...
<footer id="footer"><!--Footer-->
            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="companyinfo">
                        <h2><a href={{URL::to('/')}}><img src="{{asset('frontend/images/logo.png')}}" style="width: 100px; height:100px" alt="">
                        ECosmetic</h2>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright © <script>document.write(new Date().getFullYear())</script> ECosmetic Ltd. All rights reserved.</p>
                <p class="pull-right">
            </div>
        </div>
    </div>
